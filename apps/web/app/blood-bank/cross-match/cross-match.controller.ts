...
import { CreateRequestDto, RegisterSampleDto, RecordCrossMatchDto, ElectronicXMDto, PatientGroupingDto } from "./dto";
...
export class CrossMatchController {
  ...
  @Permissions(PERM.BB_CROSSMATCH_CREATE)
  patientGrouping(@Req() req: any, @Param("id") requestId: string, @Body() dto: PatientGroupingDto) {
