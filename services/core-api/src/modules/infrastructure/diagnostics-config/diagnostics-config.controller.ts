...
import { DiagnosticsConfigService, Principal } from "./diagnostics-config.service";
import {
  CreateSectionDto,
  UpdateSectionDto,
  ListSectionsQuery,
...
export class DiagnosticsConfigController {
  ...
  getPanelItems(@Req() req: any, @Param("id") id: string) {
    return this.svc.getPanelItems(this.principalFrom(req), id);
  }

  @Put("items/:id/panel-items")
  replacePanelItems(@Req() req: any, @Param("id") id: string, @Body() dto: ReplacePanelItemsDto) {
    return this.svc.replacePanelItems(this.principalFrom(req), id, dto);
  }

  // ---------------------- Parameters (Lab) ----------------------
  @Get("items/:id/parameters")
  listParameters(@Req() req: any, @Param("id") id: string) {
    return this.svc.listParameters(this.principalFrom(req), id);
  }

  @Post("items/:id/parameters")
  createParameter(@Req() req: any, @Param("id") id: string, @Body() dto: CreateParameterDto) {
    return this.svc.createParameter(this.principalFrom(req), id, dto);
  }
  ...
  deleteParameter(@Req() req: any, @Param("id") id: string) {
    return this.svc.deleteParameter(this.principalFrom(req), id);
  }

  // ---------------------- Reference ranges ----------------------
  @Get("parameters/:id/ranges")
  listRanges(@Req() req: any, @Param("id") id: string) {
    return this.svc.listRanges(this.principalFrom(req), id);
  }

  @Post("parameters/:id/ranges")
  createRange(@Req() req: any, @Param("id") id: string, @Body() dto: CreateReferenceRangeDto) {
    return this.svc.createRange(this.principalFrom(req), id, dto);
  }
  ...
  @Delete("ranges/:id")
  deleteRange(@Req() req: any, @Param("id") id: string) {
    return this.svc.deleteRange(this.principalFrom(req), id);
  }

  // ---------------------- Templates (Imaging) ----------------------
  @Get("items/:id/templates")
  listTemplates(@Req() req: any, @Param("id") id: string) {
    return this.svc.listTemplates(this.principalFrom(req), id);
  }

  @Post("items/:id/templates")
  createTemplate(@Req() req: any, @Param("id") id: string, @Body() dto: CreateTemplateDto) {
    return this.svc.createTemplate(this.principalFrom(req), id, dto);
  }
  ...
  // ---------------------- Charge mapping ----------------------
  @Get("charge-maps")
  listChargeMaps(@Req() req: any, @Query() q: ListChargeMapsQuery) {
    return this.svc.listChargeMaps(this.principalFrom(req), q);
  }

  @Post("charge-maps")
  createChargeMap(@Req() req: any, @Body() dto: CreateChargeMapDto) {
    return this.svc.createChargeMap(this.principalFrom(req), dto);
  }

  @Put("charge-maps/:id")
  updateChargeMap(@Req() req: any, @Param("id") id: string, @Body() dto: UpdateChargeMapDto) {
    return this.svc.updateChargeMap(this.principalFrom(req), id, dto);
  }

  @Delete("charge-maps/:id")
  deleteChargeMap(@Req() req: any, @Param("id") id: string) {
    return this.svc.deleteChargeMap(this.principalFrom(req), id);
  }

  @Get("unmapped")
  unmapped(@Req() req: any, @Query() q: UnmappedQuery) {
    return this.svc.listUnmapped(this.principalFrom(req), q);
  }
}
